	...
	<div class="card-body">
		...
		<form method="post" action="<?=current_url(true)?>" class="form-horizontal" enctype="multipart/form-data">
			...
			<div class="row mb-3">
					...
					<div class="col-sm-5">
						<?php
						if (!empty($result['file_logo']) && file_exists(ROOTPATH . '/images/' . $result['file_logo']))
						echo '<div class="img-choose mb-3"><img src="'. base_url() . '/images/' . $result['file_logo'] . '?r='.time().'"/></div>';
