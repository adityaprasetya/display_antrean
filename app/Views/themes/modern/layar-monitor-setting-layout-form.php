				...
				<div class="row mb-3">
					...
					<div class="col-sm-5">
						<div class="input-group">
							...
							<span class="text-muted"><strong>Folder</strong>: Semua file video <strong>(.mp4)</strong> pada folder videos akan otomatis diputar berurutan sesuai nama file</span>
						</div>
					</div>
				</div>
				<div class="row mb-3">
