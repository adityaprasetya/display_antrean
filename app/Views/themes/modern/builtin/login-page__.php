...
<link rel="stylesheet" type="text/css" href="<?=$config->baseURL . '/themes/modern/builtin/css/login.css?r='.time()?>"/>
<link rel="stylesheet" type="text/css" href="<?=$config->baseURL . '/themes/modern/builtin/css/login-header.css?r='.time()?>"/>
...
<body>
	...
	<div class="login-container">
		<div class="login-header">
			<div class="logo">
				<img src="<?php echo $config->baseURL . '/images/' . $settingWeb->logo_login?>">
			</div>
