...
class Layar extends \App\Controllers\BaseController
{
	public function __construct() {
		...
		$this->addJs ( $this->config->baseURL . 'themes/modern/js/layar-ambil-antrian.js' );
		$this->addJs ( $this->config->baseURL . 'themes/modern/js/layar-monitor.js' );
	}
	...
	public function show_layar_monitor() 
	{
		...
		if (!empty($_GET['id'])) 
		{
			...
			$this->addJs ( $this->config->baseURL . 'vendors/plyr/plyr.js' );
			$this->addJs ( $this->config->baseURL . 'themes/modern/js/layar-monitor-show.js' );
			$this->addJs( $this->config->baseURL . 'themes/modern/js/layar-liveupdate-monitor-antrian.js' );
			$this->addStyle ( $this->config->baseURL . 'themes/modern/css/layar-monitor-show.css' );
			$this->addStyle ( $this->config->baseURL . 'themes/modern/css/layar-monitor-show-font.css' );
			$this->addStyle ( $this->config->baseURL . 'vendors/plyr/plyr.css' );		
