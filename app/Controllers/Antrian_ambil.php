...
class Antrian_ambil extends \App\Controllers\BaseController
{
	public function __construct() {
		...
		$this->addJs ( $this->config->baseURL . 'themes/modern/js/antrian-ambil.js');
		$this->addJs ( $this->config->baseURL . 'themes/modern/js/antrian-ambil-liveupdate.js');
	}
	...
	public function index()
	{
		...
		{
			/* $this->addJs ( $this->config->baseURL . 'themes/modern/js/antrian-liveupdate-urut.js');
