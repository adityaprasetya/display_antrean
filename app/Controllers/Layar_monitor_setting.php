...
class Layar_monitor_setting extends \App\Controllers\BaseController
{
	public function __construct() {
		...
		// $this->addJs ( $this->config->baseURL . 'themes/modern/js/layar-monitor-setting.js?r=' . time());
		// $this->addStyle ( $this->config->baseURL . 'themes/modern/builtin/css/setting.css');
	...
	public function edit_kategori() {
		...
		$this->addStyle ( $this->config->baseURL . 'themes/modern/css/layar-monitor-setting-kategori.css');
		...
		$this->addJs($this->config->baseURL . 'themes/modern/js/layar-monitor-setting.js');
