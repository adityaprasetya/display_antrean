...
class Setting_app extends \App\Controllers\BaseController
{
	public function __construct() {
		...
		$this->addJs ( $this->config->baseURL . 'vendors/spectrum/spectrum.min.js?r=' . time());
		$this->addJs ( $this->config->baseURL . 'themes/modern/js/setting-logo.js?r=' . time());
		$this->addJs ( $this->config->baseURL . 'themes/modern/js/image-upload.js?r=' . time());
		$this->addStyle ( $this->config->baseURL . 'vendors/spectrum/spectrum.css');
		$this->addStyle ( $this->config->baseURL . 'themes/modern/builtin/css/setting-app.css');
		// $this->addStyle ( $this->config->baseURL . 'themes/modern/builtin/css/login-header.css');
