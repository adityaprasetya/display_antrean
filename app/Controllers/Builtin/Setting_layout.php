...
class Setting_layout extends \App\Controllers\BaseController
{
	public function __construct() {
		...
		$this->addJs ( $this->config->baseURL . 'themes/modern/builtin/js/setting-layout.js?r=' . time());
		$this->addStyle ( $this->config->baseURL . 'themes/modern/builtin/css/setting-layout.css');
	...
	public function index() 
	{
		...
		$data['list_bootswatch_theme'] = scandir(ROOTPATH . 'vendors/bootswatch');
