...
class Menu extends \App\Controllers\BaseController
{
	...
	public function __construct() {
		...
		$this->addJs ($this->config->baseURL . 'themes/modern/builtin/js/admin-menu.js');
		...
		$this->addJs($this->config->baseURL . 'vendors/dragula/dragula.min.js');
		$this->addStyle($this->config->baseURL . 'vendors/dragula/dragula.min.css');
