...
class Antrian_rekap extends \App\Controllers\BaseController
{
	public function __construct() {
		...
		$this->addJs ( $this->config->baseURL . 'vendors/bootstrap-datepicker/js/bootstrap-datepicker.js' );
		$this->addJs ( $this->config->baseURL . 'themes/modern/js/antrian-rekap.js');
		$this->addStyle ( $this->config->baseURL . 'vendors/bootstrap-datepicker/css/bootstrap-datepicker3.css');
	}
