...
class Antrian_panggil extends \App\Controllers\BaseController
{
	public function __construct() {
		...
		$this->addJs ( $this->config->baseURL . 'themes/modern/js/antrian-panggil.js');
	}
	...
	public function index()
	{
		...
		{
			$this->addJs ( $this->config->baseURL . 'themes/modern/js/antrian-panggil-liveupdate.js');
	...
	public function panggil_antrian() 
	{
		...
		if (!empty($_GET['kategori'])) 
		{
			$this->addJs ( $this->config->baseURL . 'themes/modern/js/antrian-liveupdate-panggil.js');
